...
import org.apache.doris.tablefunction.FtpTableValuedFunction;
import org.apache.doris.tablefunction.TableValuedFunctionIf;

import java.util.Map;

/** ftp */
public class Ftp extends TableValuedFunction implements SupportPruneNestedColumn {
    public Ftp(Properties properties) {
        super("ftp", properties);
    }
    ...
    protected TableValuedFunctionIf toCatalogFunction() {
        try {
            ...
            return new FtpTableValuedFunction(arguments);
        } catch (Throwable t) {
            throw new AnalysisException("Can not build ftp(): " + t.getMessage(), t);
        }
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitFtp(this, context);
    }
