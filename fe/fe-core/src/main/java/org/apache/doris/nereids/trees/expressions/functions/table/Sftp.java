...
import org.apache.doris.tablefunction.SftpTableValuedFunction;
import org.apache.doris.tablefunction.TableValuedFunctionIf;

import java.util.Map;

/** sftp */
public class Sftp extends TableValuedFunction implements SupportPruneNestedColumn {
    public Sftp(Properties properties) {
        super("sftp", properties);
    }
    ...
    protected TableValuedFunctionIf toCatalogFunction() {
        try {
            ...
            return new SftpTableValuedFunction(arguments);
        } catch (Throwable t) {
            throw new AnalysisException("Can not build sftp(): " + t.getMessage(), t);
        }
    }

    @Override
    public <R, C> R accept(ExpressionVisitor<R, C> visitor, C context) {
        return visitor.visitSftp(this, context);
    }
