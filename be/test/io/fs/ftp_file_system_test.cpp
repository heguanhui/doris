...
class FtpFileSystemTest : public testing::Test {
public:
    void SetUp() override {}
    void TearDown() override {}
};

TEST_F(FtpFileSystemTest, TestCreateWithValidProperties) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
    properties["user"] = "testuser";
    properties["password"] = "testpass";

    auto result = FtpFileSystem::create(properties, "ftp_test");
    ASSERT_TRUE(result.ok()) << result.status();
    auto fs = result.value();
    ASSERT_NE(fs, nullptr);
}

TEST_F(FtpFileSystemTest, TestCreateWithoutUri) {
    std::map<std::string, std::string> properties;
    properties["user"] = "testuser";
    properties["password"] = "testpass";
...
TEST_F(FtpFileSystemTest, TestCreateWithInvalidUriScheme) {
    std::map<std::string, std::string> properties;
    ...
    auto result = FtpFileSystem::create(properties, "ftp_test");
    ASSERT_FALSE(result.ok());
    EXPECT_TRUE(result.status().to_string().find("ftp://") != std::string::npos);
}

TEST_F(FtpFileSystemTest, TestCreateWithSftpUri) {
    std::map<std::string, std::string> properties;
...
TEST_F(FtpFileSystemTest, TestCreateWithAnonymousAccess) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
...
TEST_F(FtpFileSystemTest, TestCreateWithPort) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com:2121/";
    properties["user"] = "testuser";
    properties["password"] = "testpass";
...
TEST_F(FtpFileSystemTest, TestNotSupportedOperations) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
    properties["user"] = "testuser";
    properties["password"] = "testpass";
...
TEST_F(FtpFileSystemTest, TestFileSystemType) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
    ...
    ASSERT_TRUE(result.ok());
    auto fs = result.value();
    EXPECT_EQ(fs->type(), FileSystemType::FTP);
}

class FtpFileReaderTest : public testing::Test {
public:
    void SetUp() override {}
    void TearDown() override {}
};

TEST_F(FtpFileReaderTest, TestCreateWithKnownFileSize) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
    properties["user"] = "testuser";
    properties["password"] = "testpass";
    ...
    auto result = FtpFileReader::create("/data/test.csv", properties, opts, nullptr);
    ASSERT_TRUE(result.ok()) << result.status();
...
TEST_F(FtpFileReaderTest, TestCloseReader) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
...
TEST_F(FtpFileReaderTest, TestReadAfterClose) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
...
class FtpFileWriterTest : public testing::Test {
public:
    void SetUp() override {}
    void TearDown() override {}
};

TEST_F(FtpFileWriterTest, TestCreateWriter) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
    properties["user"] = "testuser";
    properties["password"] = "testpass";

    auto result = FtpFileWriter::create("/data/test.csv", properties);
    ASSERT_TRUE(result.ok()) << result.status();
...
TEST_F(FtpFileWriterTest, TestAppendData) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
...
TEST_F(FtpFileWriterTest, TestAppendMultipleSlices) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
...
TEST_F(FtpFileWriterTest, TestAppendAfterClose) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
...
TEST_F(FtpFileWriterTest, TestDoubleClose) {
    std::map<std::string, std::string> properties;
    properties["uri"] = "ftp://ftp.example.com/";
