...
public class SftpTableValuedFunction extends ExternalFileTableValuedFunction {
    public static final String NAME = "sftp";

    public SftpTableValuedFunction(Map<String, String> properties) throws AnalysisException {
        Map<String, String> props = super.parseCommonProperties(properties);
        props.put(StorageProperties.FS_SFTP_SUPPORT, "true");
        try {
    ...
    public BrokerDesc getBrokerDesc() {
        return new BrokerDesc("SftpTvfBroker", processedParams);
    }

    @Override
    public String getTableName() {
        return "SftpTableValuedFunction";
    }
}
